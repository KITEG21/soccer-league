        ...
        <div className="flex flex-col md:flex-row md:items-center gap-6">
          ...
          <div className="flex-1 space-y-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-8 gap-y-2 text-sm text-muted-foreground">
              <p><span className="font-semibold text-foreground">Provincia:</span> {team.province || "No definida"}</p>
              <p><span className="font-semibold text-foreground">Mascota:</span> {team.mascot || "No definida"}</p>
              <p><span className="font-semibold text-foreground">Color:</span> {team.color || "No definido"}</p>
              <p><span className="font-semibold text-foreground">Partidos jugados:</span> {team.championships_played || 0}</p>
              <p><span className="font-semibold text-foreground">Partidos ganados:</span> {team.championships_won || 0}</p>
            </div>
          </div>
        </div>
      </div>
