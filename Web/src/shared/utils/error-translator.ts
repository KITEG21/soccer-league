export const errorTranslations: Record<string, string> = {
  ...
  "email already exists": "Ya existe un usuario con ese email",
  "cannot modify your own user": "No puedes modificar tu propio usuario",
  "email is required": "El email es requerido",
  "invalid email": "Email inválido",
  "password must be at least 8 characters": "La contraseña debe tener al menos 8 caracteres",
  "password must be at most 72 characters": "La contraseña no puede superar los 72 caracteres",
